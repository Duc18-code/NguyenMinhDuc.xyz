...
local Alert = loadstring(Game:HttpGet"https://raw.githubusercontent.com/Duc18-code/NguyenMinhDuc.xyz/main/Mingameui.lua.txt")()
...
Main:Label("Script By NguyenMinhDucDz#6078")
Main:Button("Copy Discord Link",function()
setclipboard("https://discord.gg/taCssy8S") 
end)
...
ESP:Toggle("Esp Gear", false,"Highlight Gear", function(value)
    ...
    Serv:Button("Vào lại Server",function()
        game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    
    Serv:Button("Đổi Sever",function()
        while wait() do
    ...
    Serv:Button("Sao Chép Server Job ID",function()
	...
	Serv:Button("Chuyển Sever",function()
...
for _, fruitData in pairs(result) do
    ...
    Alert:create("Tải xong rồi anh bạn à 🗿!")
